...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			configproperty.Table:    configproperty.ValidColumn,
			eventservicelog.Table:   eventservicelog.ValidColumn,
			installedupgrades.Table: installedupgrades.ValidColumn,
			ldapuser.Table:          ldapuser.ValidColumn,
			manageduser.Table:       manageduser.ValidColumn,
			mappedldapgroup.Table:   mappedldapgroup.ValidColumn,
			mappedoidcgroup.Table:   mappedoidcgroup.ValidColumn,
			oidcgroup.Table:         oidcgroup.ValidColumn,
			oidcuser.Table:          oidcuser.ValidColumn,
