...
const (
	// Label holds the string label denoting the manageduser type in the database.
	Label = "managed_user"
	...
	// FieldNonExpiryPassword holds the string denoting the non_expiry_password field in the database.
	FieldNonExpiryPassword = "non_expiry_password"
...
// OrderOption defines the ordering options for the ManagedUser queries.
...
// ByNonExpiryPassword orders the results by the non_expiry_password field.
func ByNonExpiryPassword(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldNonExpiryPassword, opts...).ToFunc()
}
